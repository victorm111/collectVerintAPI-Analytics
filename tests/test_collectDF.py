...
class test_ClassCollectEngID:
    ...
    def test_collect_df(self, test_read_config_file, getCCaaSToken, getVerintToken) -> any:
        ...
        LOGGER.debug('test_collect_df:: test_Analytics_ED_buildRequest()')
        self.df_DetailEngDaily = test_DetailReport.test_AnalyticdED_sendRequest()  # retrieves daily data
        ...
        LOGGER.debug('test_collect_df:: finished collecting data frames')
        return
    ...
    def test_compare_df(self) -> any:
        ...
        assert len(self.df_DetailEngDaily_sorted_NoteRecorded) == 0, 'test_collectDF mismatch Analytics reported calls and Verint S&R recordngs'
